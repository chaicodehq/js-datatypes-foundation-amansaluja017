...
export function isAnyWaitlisted(passengers) {
  ...
  return passengers.some(passenger => passenger.status === "waitlisted" ? true : false)
}
...
export function areAllConfirmed(passengers) {
  // Your code here
    ...
    return passengers.every(passenger => passenger.status === "confirmed" ? true : false);
}
...
export function getWaitlistedPassengers(passengers) {
  ...
  return passengers.filter(passenger => passenger.status === "waitlisted" ?? passenger)
};
