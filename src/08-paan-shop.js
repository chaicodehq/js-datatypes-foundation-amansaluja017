...
export function updatePrices(menu, increase) {
  ...
  if (typeof(menu) !== "object" || typeof(increase) !== "number") return {};

  return Object.fromEntries(Object.entries({...menu}).map(([a, b]) => [a , b + increase]));
}

export function mergeDailySpecials(regularMenu, specialsMenu) {
  // Your code here

  if (typeof(regularMenu) !== "object" || typeof(specialsMenu) !== "object") regularMenu, specialsMenu = {};
